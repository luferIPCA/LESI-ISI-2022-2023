...
namespace WebAPI_Client
{
    public partial class Form1 : Form
    {
        ...
        {
            string url = "https://localhost:44348/api/Security/login";
            ...
            { username = "lufer", password = "Benfica2022" }), Encoding.UTF8, "application/json")).Result;
        ...
        {
            string url = "https://localhost:44348/api/User/all";
        ...
        {
            string url = "https://localhost:44348/api/User/addUser";
            HttpClient client = new HttpClient();
            client.BaseAddress = new Uri(url);
